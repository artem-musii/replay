...
Status: **implemented inventory with verification caveats**, last reconciled with the repository on 2026-08-28 and the 2026-08-26 WebMCP draft. The current candidate defines 19 imperative tools plus the declarative final-review form: 18 before report preview and 19 after `add_report_note` joins. OpenAI's current Site Tools browser exposes the top-level imperative inventory, not declarative HTML form tools. ChatGPT Work or Codex may still interact with a form through ordinary browser capabilities, but that is not a WebMCP call or authorization to operate REPLAY's human confirmation controls. The preserved public smoke verified the historical `f980d28` 17/18-tool lifecycle; current candidate deployment/client/model proof is pending.
