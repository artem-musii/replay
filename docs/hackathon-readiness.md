...
This document is an audit and submission plan. It does **not** assert that the final video has been recorded or that the supported-model run has passed. Application commit `b252fbde9551d0a1d2c41a1282ced66dc8ae1b20` has passed clean CI, deployed to the public URL, and been byte-verified there.
...
Application commit `b252fbde9551d0a1d2c41a1282ced66dc8ae1b20` passed Actions run `33274844653`: verify/build job `99159652619`, deploy job `99160674554`, and deployed-byte verification job `99160705929`. Pages deployment `6160091470` published artifact `9721285202` (3,655,679 compressed bytes; SHA-256 `5505a03a515a0c455f786a0f9fec7a6d9376d7046c77072d9df6d9c2412d8e1b`); the live `release-evidence.json` and an independent verifier matched all 46 payload files / 5,297,092 bytes with manifest SHA-256 `22c26f2b61944986272a28d7568fd1421b96b62d37e07dec60fd34895f2aa9c9`. This closes the release-identity blocker. The current release's clean hosted deterministic suite covers collision response, the high-speed case, and WebMCP proposal semantics; separate post-fix local stress runs cover exact-impact continuation. A fresh supported-model trace and the video remain the two hard gates above.
