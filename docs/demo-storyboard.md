...
| 0:35–0:55 | Scene is primary. Timeline and activity remain in frame.                                                                                                   | Submit reconstruction prompt; point to the new paths only after they appear.                          | Set one or both trajectories; mark only a non-confirmed impact.            | Show a visible, attributable agent mutation through WebMCP.                | Paths/impact, timeline, and agent activity agree.                                        |
