...
REPLAY’s own source is licensed under the checked-in MIT `LICENSE`. Direct runtime code dependencies use permissive MIT, ISC, or Apache-2.0 licenses; the bundled Inter font uses OFL-1.1.
...
| [Playwright](https://playwright.dev/) `@playwright/test`                          |           1.62.1 | Desktop/mobile end-to-end browser tests and artifacts. | Apache-2.0       | Current release `00688d8`: 103 passed, 5 intentional mobile screenshot-owner skips, 0 failed; `f980d28` baseline: 32/32 passed. |
